...
def init_conf(
    num_ptcl, mesh_shape, box_size, num_devices=None, max_ptcl_per_slice=1.2, max_share_ptcl=20000,
    max_share_gather_ptcl=50000, multigpu_mode="mesh_halo", particle_halo_gather_mesh_halo=False
):
    ...
    conf_mGPU = Configuration(
        ...
        multigpu=MultiGPUConfiguration(compute_mesh=compute_mesh, mode=multigpu_mode,
                                       ),
        ...
        particle_halo_gather_mesh_halo=particle_halo_gather_mesh_halo, to_save_z=[1, 2 / 3, 1 / 3, 0], a_start=1 / 60,
