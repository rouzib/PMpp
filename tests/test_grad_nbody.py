...
def _init_confs():
    ...
    conf_pmpp = Configuration(
        ...
        max_ptcl_per_slice=int(num_ptcl**3 / len(gpu_devices) * 2.5), max_share_ptcl=4000, max_share_gather_ptcl=8000,
        a_start=1 / 60, a_stop=1 / 15, a_nbody_maxstep=1 / 60, pallas_cic=False, cosmo_dtype=jnp.float64,
