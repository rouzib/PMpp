...
The kernels are deliberately private implementation details of :mod:`pmpp.gather`
and :mod:`pmpp.scatter`.  On the qualified float32 GPU/JAX combination they replace
