...
from ..numerics.fft import fftfreq
from ..distributed.configuration import (
    MultiGPUConfiguration, build_multigpu_configuration, initialize_multigpu_runtime,
)
from ..cic.pallas import pallas_cic_supported
    ...
    def __post_init__(self):
        ...
        if self.pallas_cic and not pallas_cic_supported(self.float_dtype):
            warnings.warn(
                ...
                "float32 GPU backend on a qualified JAX minor line (currently 0.6 or 0.10).", RuntimeWarning,
                stacklevel=2,
            )
