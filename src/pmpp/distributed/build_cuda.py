...
_REQUIRED_ROUTING_TARGETS = frozenset({
    ...
    "pmpp_route_bidir_drift_pack_primal_i16", "pmpp_route_bidir_drift_merge_primal_i16",
    "pmpp_route_bidir_drift_merge_hybrid_primal_i16", "pmpp_route_pack_f64",
...
def _existing_artifact_matches(target: Path, architectures: str) -> bool:
    ...
    return (
        ...
        and _HYBRID_FEATURE in (manifest.get("features") or ())
